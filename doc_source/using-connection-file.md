...
1. Add the parameters and parameter values below the groups using the following format:
...
| --- | --- | --- | --- | 
| format | string |  |   This is a compulsory parameter\. The parameter value must be `1.0`\. If your `.dcv` file does not include this parameter, parsing fails\.   | 
